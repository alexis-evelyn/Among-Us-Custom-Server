...
crewmateProperties = open('../gradle.properties')

crewmateVersion = "Unset"

for line in crewmateProperties:
    if "server_version" in line:
        crewmateVersion = line.split(" ")[2].split("\n")[0]
        break
...
html_theme_options = {
    ...
    "contribute": True,
    "github_fork": "alexis-evelyn/Crewmate",
