...
title: '[Server Version]: Bug Name or Short Description'
labels: 'bug'
...
- [ ] **Have you checked to make sure this bug wasn't already fixed in the latest version of the server?**
