...
public class ReliablePacket {
	public static byte[] handleReliablePacket(Server server, InetAddress clientAddress, int clientPort, int byteLength, byte... reliableBytes) {
...
//					return JoinLobbyPacket.handleJoinLobby(server, clientAddress, clientPort, payloadLength, packetData); // 11 Bytes Total
					return new byte[0];
				case GAME_DATA: // 0x05
